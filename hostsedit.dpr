...
Writeln(edit,'#');
Writeln(edit,'# This is a sample HOSTS file used by Microsoft TCP/IP for Windows.');
Writeln(edit,'#');
Writeln(edit,'# This file contains the mappings of IP addresses to host names. Each');
Writeln(edit,'# entry should be kept on an individual line. The IP address should');
Writeln(edit,'# be placed in the first column followed by the corresponding host name.');
Writeln(edit,'# The IP address and the host name should be separated by at least one');
Writeln(edit,'# space.');
Writeln(edit,'#');
Writeln(edit,'# Additionally, comments (such as these) may be inserted on individual');
Writeln(edit,'# lines or following the machine name denoted by a ''#'' symbol.');
Writeln(edit,'#');
Writeln(edit,'# For example:');
Writeln(edit,'#');
Writeln(edit,'#      102.54.94.97     rhino.acme.com          # source server');
Writeln(edit,'#       38.25.63.10     x.acme.com              # x client host');
Writeln(edit,'');
